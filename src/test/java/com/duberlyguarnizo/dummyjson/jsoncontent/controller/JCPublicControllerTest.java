...
class JCPublicControllerTest {
    ...
    void getJsonContentDetailByName_whenContentExists_returnsPageContent() {
        ...
        given()
                ...
                .accept(ContentType.JSON)
                .when()
                .get("/api/v1/public/json?name=" + URLEncoder.encode(existingName, StandardCharsets.UTF_8))
                .then()
                .statusCode(HttpStatus.OK.value())
                .contentType(ContentType.JSON)
    ...
    void getJsonContentDetailByName_whenContentDoesNotExist_returnsEmptyPage() {
        ...
        given()
                ...
                .accept(ContentType.JSON)
                .when()
                .get("/api/v1/public/json?name=" + URLEncoder.encode(nonExistingName, StandardCharsets.UTF_8))
                .then()
                .statusCode(HttpStatus.OK.value())
                .contentType(ContentType.JSON)
